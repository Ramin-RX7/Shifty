...
This is called Containerizing a function.
...
- Permanently changing behavior of the function from outside (not necessarily permanently, but at least for several calls)
- Having a behavioral data holder

Things to note about containerizing a function:

- Function containerizing is less secure than using arguments:
    When using function container, the behavior of the function is not explicit in calls.
