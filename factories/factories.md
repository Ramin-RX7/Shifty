...
Factories can not be defined twice in the code and redefinition of them result in _[[builtins/errors#FactoryRedefinitionError|FactoryRedefinitionError|]]_. This happens when a factory is being created in a [factories mapping](./factories_mapping.md) that already contains another factory with similar name.
# Classes

For details about classes please refer to [[classes]] which is a dedicated part of documentation to classes.
