...
> [!bug] Bug!
> This feature has conflict with the functions principal of [[factories/functions/functions#Overloading functions|functions Overloading]] since it seems this wants to enable function overloading!
> A better approach must be found for this section.
...
> [!attention] Attention
> This method has the same issue as [[#get]] where function overloading is the solution.
> Note that since function prototype must stay the same (taken from [[Notes#Prototype]], speicially Solution 2)
...
> Read more about [[for_loop|For Loops]] and how they work
...
> [!attention]
> Function parameter finalizing is crucial once again here. If a class override this method with extra parameters, on deletion of the instance, internal error will be raised because of user fault!