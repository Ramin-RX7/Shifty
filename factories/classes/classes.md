...
Classes can have class variables/attributes which is a shared attribute across all instances.
...
> read more in [[special_methods#Casting methods (Type conversion)|Casting Methods]]
...
## Shielded attributes (Waiting for decision)
...
Methods are separately documented in [[methods]].
