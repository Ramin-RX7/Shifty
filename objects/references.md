...
Before getting into references, it's better to have a good understanding of [[objects]] VM and OM.
...
References are a way of getting the object a variable is pointing to.
...
- When sending them as a [[factories/functions/functions#Parameters|function arguments]], the actual object will be sent.
