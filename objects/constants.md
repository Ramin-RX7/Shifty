...
As you saw in the `OM`, there is a key called `const` which indicates whether the data of the object can be changed or not.
...
> [!bug] TODO
> this is not a correct explanation and does not clarify how is this exactly implemented in the language itself.
